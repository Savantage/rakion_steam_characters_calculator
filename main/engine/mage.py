...
mage_shoulderS = {'Default': Wearable(),
...
class Mage:
    ...
    def __init__(self):
        self.basic = BASIC_MAGE
        self.range = RANGE_MAGE
        self.special = SPECIAL_MAGE
        self.grip = GRIP_MAGE
        self.cd = CELLDESTRUCTION_MAGE
        self.hp = ENERGY_MAGE
        self.ap = ARMOR_MAGE
        self.attackSpeed = ATTACKSPEED_MAGE
        self.movementSpeed = MOVEMENTSPEED_MAGE
        self.cp = CELLPOINTS_MAGE

        self.basicPerPoint = BASIC_PER_STATPOINT_MAGE
        self.rangePerPoint = RANGE_PER_STATPOINT_MAGE
        self.specialPerPoint = SPECIAL_PER_STATPOINT_MAGE
        self.gripPerPoint = GRIP_PER_STATPOINT_MAGE
        self.cdPerPoint = CELLDEST_PER_STATPOINT_MAGE
        self.hpPerPoint = ENERGY_PER_STATPOINT_MAGE
        self.apPerPoint = ARMOR_PER_STATPOINT_MAGE
        self.attSpeedPerPoint = ATTACKSPED_PER_STATPOINT_MAGE
        self.movSpeedPerPoint = MOVSPEED_PER_STATPOINT_MAGE
        self.cpPerPoint = CELLPOINTS_PER_STATPOINT_MAGE

        self.PAST50 = PAST50
        self.PAST80 = PAST80

        self.helmetS = mage_helmetS
        self.shoulderS = mage_shoulderS
        self.armorS = mage_armorS
        self.armS = mage_armS
        self.meleeS = mage_meleeS
        self.rangeS = mage_rangeS

    def advancedClass(self):
        self.basic = BASIC_MAGE + 3
        self.range = RANGE_MAGE + 5
        self.special = SPECIAL_MAGE + 5
        self.grip = GRIP_MAGE + 5
        self.cd = CELLDESTRUCTION_MAGE + 0.85
        self.hp = ENERGY_MAGE + 6
        self.ap = ARMOR_MAGE + 6
        self.attackSpeed = ATTACKSPEED_MAGE + 4.9
        self.movementSpeed = MOVEMENTSPEED_MAGE + 0.33
        self.cp = CELLPOINTS_MAGE + 175
