...
archer_meleeS = {'Default': Wearable(),
                 ...
                 ''
                 ' Hoz': Wearable("GReaper Hoz", 10, 7, 8, 11, 7, 12, 12, 1.22, 0.13, 600),
...
class Archer:
    ...
    def advancedClass(self):
        self.basic = BASIC_ARCHER + 0
        self.range = RANGE_ARCHER + 0
        self.special = SPECIAL_ARCHER + 0
        self.grip = GRIP_ARCHER + 0
        self.cd = CELLDESTRUCTION_ARCHER + 0
        self.hp = ENERGY_ARCHER + 0
        self.ap = ARMOR_ARCHER + 0
        self.attackSpeed = ATTACKSPEED_ARCHER + 0
        self.movementSpeed = MOVEMENTSPEED_ARCHER + 0
        self.cp = CELLPOINTS_ARCHER + 0
